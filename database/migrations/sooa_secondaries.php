...
return new class extends Migration
{
    ...
    {
        Schema::create('sooa_secondaries', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('eca_1')->nullable();
            $table->string('grades_eca_1')->nullable();
            $table->integer('eca_2')->nullable();
            $table->string('grades_eca_2')->nullable();
