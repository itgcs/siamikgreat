            ...
            <div class="col-md-12">
                ...
                <div>
                    @if (session('role') == 'superadmin')
                        <form method="POST" action="{{ route('actionSuperEditSchedule', ['gradeId' => $gradeId, 'scheduleId' => $data[0]->id]) }}">
                    @elseif (session('role') == 'admin')
                        <form method="POST" action="{{ route('actionAdminEditSchedule', ['gradeId' => $gradeId, 'scheduleId' => $data[0]->id]) }}">
                    @endif
                    @csrf
                    @method('PUT')
                    <div class="card card-dark">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <label for="teacher_companion">Assisstant Teacher<span style="color: red"> *</span></label>
