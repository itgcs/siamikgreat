            ...
            <tbody>
                ...
                <tr id={{'index_payment_' . $el->id}}>
                    ...
                    <td class="project-actions text-right toastsDefaultSuccess">
                        <a class="btn btn-info btn" href="{{url('/admin/grades/payment-grades/')}}/{{$el->id}}/edit">
                            {{-- <i class="fa-solid fa-user-graduate"></i> --}}
                            <i class="fas fa-pencil-alt">
                            </i>
                            Edit
                        </a>
                        <a class="btn btn-danger btn" href="javascript:void(0)" id="delete-payment" data-id="{{ $el->id }}" data-type="{{ $el->type }}">
