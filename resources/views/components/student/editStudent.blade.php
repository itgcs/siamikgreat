            ...
            <div class="col-md-12">
                ...
                <div>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input name="studentName" type="text" class="form-control" id="studentName"
                                        placeholder="Enter name" value="{{old('name') ? old('name'):  $data->student->name }}" required>
                                        @if($errors->any())
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="studentGender" class="form-control" required>
                                                ...
                                                <option selected> {{ old('gender')? old('gender') : $data->student->gender}}</option>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        ...
                                        <input name="studentPlace_birth" type="text" class="form-control"
                                            id="studentPlace_birth" placeholder="Enter city" value="{{old('place_birth')? old('place_birth') : $data->student->place_birth}}" required>
                                            @if($errors->any())
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input name="studentNationality" type="text" class="form-control"
                                            id="studentNationality" placeholder="Enter nationality" value="{{old('nationality')? old('nationality') : $data->student->nationality}}" required>
                                            @if($errors->any())
                                ...
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        ...
                                        <input name="studentId_or_passport" type="text" class="form-control"
                                            id="studentId_or_passport" placeholder="Enter ID/Passport" value="{{old('id_or_passport')? old('id_or_passport') : $data->student->id_or_passport}}" required>
                                            @if($errors->any())
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input name="studentPlace_of_issue" type="text" class="form-control"
                                             @php
                                                 $place_of_issue = $data->student->place_of_issue? $data->student->place_of_issue : ''
                                             @endphp

                                            id="studentPlace_of_issue" value="{{old('place_of_issue')? old('place_of_issue') : $place_of_issue}}" placeholder="Enter place">
                                            @if($errors->any())
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="studentReligion" class="form-control" required>
                                                ...
                                                @php
                                                   ...
                                                   $student_religion = old('religion') ? old('religion') : $data->student->religion;
                                                @endphp
                                                
                                                <option selected> {{ old('religion')? old('religion') : $data->student->religion}}</option>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group date" id="reservationdateStudentDateExp"
                                            ...
                                            <input name="studentDate_exp" type="text"
                                                ...
                                                @php
                                                   $date_exp = $data->student->date_exp ? date("d/m/Y", strtotime(old($data->student->date_exp))) : '';
                                                @endphp
                           ...
                           <div class="card-body">
                               <div class="form-group row">
                                 <div class="col-md-6">
                                   ...
                                   <input name="fatherName" type="text" class="form-control" id="fatherName"
                                       placeholder="Enter father's name" value="{{old('father_name') ? old('father_name') : $father->name}}" required>
                                       @if($errors->any())
                                 ...
                                 <div class="col-md-6">
                                    ...
                                    <input name="fatherId_or_passport" type="text" class="form-control"
                                        id="fatherId_or_passport" placeholder="Enter father's ID/Passport" value="{{old('father_id_or_passport') ? old('father_id_or_passport') : $father->id_or_passport}}" required>
                                        @if($errors->any())
                               ...
                               <div class="form-group row">
                                   <div class="col-md-6">
                                    ...
                                    <input name="fatherOccupation" type="text" class="form-control"
                                        id="fatherOccupation" placeholder="Enter father's occupation" value={{old('father_occupation') ? old('father_occupation') : $father->occupation}}> 
                                        @if($errors->any())
                                   ...
                                   <div class="col-md-6">
                                        ...
                                        <label>Religion<span style="color: red">*</span></label>
                                           <select name="fatherReligion" class="form-control" required>
                                             @php
                                                $arrReligion = array('Islam', 'Protestant Christianity', 'Catholic Christianity', 'Hinduism', 'Buddhism', 'Confucianism', 'Others');
                                                $father_religion = old('father_religion')? old('father_religion') : $father->religion;
                                             @endphp
                               ...
                               <div class="form-group row">
                                 ...
                                 <div class="col-md-4">
                                    ...
                                    <input name="fatherPlace_birth" type="text" class="form-control"
                                          id="fatherPlace_birth" placeholder="Enter city" value="{{old('father_place_birth')? old('father_place_birth') : $father->place_birth}}" required>
                                          @if($errors->any())
                                 ...
                                 <div class="col-md-4">
                                    ...
                                    <div class="input-group date" id="reservationFatherBirthDate"
                                        ...
                                        <input name="fatherBirth_date" type="text"
                                            ...
                                            data-inputmask-alias="datetime" data-inputmask-inputformat="dd/mm/yyyy" data-mask
                                            required value="{{old('father_date_birth') ? date("d-m-Y", strtotime(old('father_date_birth'))) : date("d-m-Y", strtotime($father->date_birth))}}"/>
                                    ...
                                    <input name="fatherNationality" type="text" class="form-control"
                                        id="fatherNationality" placeholder="Enter nationality" value="{{old('father_nationality')? old('father_nationality') : $father->nationality }}" required>
                                    @if($errors->any())
                               ...
                               <div class="form-group row">
                                   <div class="col-md-6">
                                       ...
                                       <input name="fatherCompany_address" type="text" class="form-control"
                                           id="fatherCompany_address" placeholder="Enter company address" value="{{old('father_company_address')? old('father_company_address') : $father->company_address}}">
                                          @if($errors->any())
                                   ...
                                   <div class="col-md-6">
                                       ...
                                       <input name="fatherCompany_phone" type="text" class="form-control"
                                           id="fatherCompany_phone" placeholder="Enter company phone" value="{{old('father_phone')? old('father_phone') : $father->phone}}">
                                       @if($errors->any())
                               ...
                               <div class="form-group">
                                 ...
                                 <input name="fatherHome_address" type="text" class="form-control" id="fatherHome_address" 
                                     placeholder="Enter name" required value="{{old('father_home_address') ? old('father_home_address') : $father->home_address}}">
                                    @if($errors->any())
                               ...
                               <div class="form-group row">
                                   <div class="col-md-4">
                                       ...
                                       <input name="fatherTelephhone" type="text" class="form-control"
                                           id="fatherTelephhone" placeholder="Enter telephone" value="{{old('father_telephone')? old('father_telephone') : $father->telephone}}">
                                           @if($errors->any())
                                   ...
                                   <div class="col-md-4">
                                    ...
                                    id="fatherMobilephone" placeholder="Enter mobilephone" required value="{{old('father_mobilephone')? old('father_mobilephone') : $father->mobilephone}}">
                                    @if($errors->any())
                                 ...
                                 <div class="col-md-4">
                                    ...
                                    <div class="input-group mb-3">
                                       ...
                                       <input name="fatherEmail" type="email" class="form-control" placeholder="Enter father's email" value="{{old('father_email')? old('father_email') : $father->email}}" required>
                                       @if($errors->any())
                       ...
                       <div class="card card-dark">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                              <div class="col-md-6">
                                ...
                                <input name="motherName" type="text" class="form-control" id="motherName"
                                    placeholder="Enter mother's name" value="{{old('mother_name')? old('mother_name') : $mother->name}}" required>
                                 @if($errors->any())
                              ...
                              <div class="col-md-6">
                                 ...
                                 <input name="motherId_or_passport" type="text" class="form-control"
                                       id="motherId_or_passport" placeholder="Enter mother's ID/Passport" value="{{old('mother_id_or_passport')? old('mother_id_or_passport') : $mother->id_or_passport}}" required>
                                    @if($errors->any())
                            ...
                            <div class="form-group row">
                                <div class="col-md-6">
                                 ...
                                 <input name="motherOccupation" type="text" class="form-control"
                                     id="motherOccupation" placeholder="Enter mother's occupation" value="{{old('mother_occupation')? old('mother_occupation') : $mother->occupation}}">
                                </div>
                                <div class="col-md-6">
                                     ...
                                     <label>Religion<span style="color: red">*</span></label>
                                       ...
                                       @php
                                          $arrReligion = array('Islam', 'Protestant Christianity', 'Catholic Christianity', 'Hinduism', 'Buddhism', 'Confucianism', 'Others');
                                          $mother_religion = old('mother_religion')? old('mother_religion') : $mother->religion;
                                       @endphp
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-md-4">
                                 ...
                                 <input name="motherPlace_birth" type="text" class="form-control"
                                     id="motherPlace_birth" placeholder="Enter city" value="{{old('mother_place_birth')? old('mother_place_birth') : $mother->place_birth}}" required>
                                    @if($errors->any())
                              ...
                              <div class="col-md-4">
                                 ...
                                 <input name="motherNationality" type="text" class="form-control"
                                     id="motherNationality" placeholder="Enter nationality" value="{{old('mother_nationality')? old('mother_nationality') : $mother->nationality}}" required>
                                     @if($errors->any())
                            ...
                            <div class="form-group">
                                 ...
                                 <input name="motherCompany_name" type="text" class="form-control" value="{{old('mother_company_name')? old('mother_company_name') : $mother->company_name}}" id="motherCompany_name"
                            ...
                            <div class="form-group row">
                                <div class="col-md-6">
                                    ...
                                    <input name="motherCompany_address" type="text" class="form-control"
                                        id="motherCompany_address" placeholder="Enter company address"  value="{{old('mother_company_address')? old('mother_company_address') : $mother->company_address}}">
                                       @if($errors->any())
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input name="motherCompany_phone" type="text" class="form-control"
                                        id="motherCompany_phone" placeholder="Enter company phone" value="{{old('mother_phone')? old('mother_phone') : $mother->phone}}">
                                    @if($errors->any())
                            ...
                            <div class="form-group">
                              ...
                              <input name="motherHome_address" type="text" class="form-control" id="motherHome_address"
                                  placeholder="Enter name" value="{{old('mother_home_address')? old('mother_home_address') : $mother->home_address}}" required >
                              @if($errors->any())
                            ...
                            <div class="form-group row">
                                <div class="col-md-4">
                                    ...
                                    <input name="motherTelephhone" type="text" class="form-control"
                                          id="motherTelephhone" placeholder="Enter telephone" value="{{old('mother_telephone')? old('mother_telephone') : $mother->telephone}}">
                                          @if($errors->any())
                                ...
                                <div class="col-md-4">
                                 ...
                                 id="motherMobilephone" placeholder="Enter mobilephone" required value="{{old('mother_mobilephone')? old('mother_mobilephone') : $mother->mobilephone}}">
                                 @if($errors->any())
                              ...
                              <div class="col-md-4">
                                 ...
                                 <div class="input-group mb-3">
                                    ...
                                    <input name="motherEmail" type="email" class="form-control" placeholder="Enter father's email" value="{{old('mother_email')? old('mother_email') : $mother->email}}" required>
                                    @if($errors->any())
                    ...
                    <div class="card card-dark">
                     ...
                     @php
                           $brotherSister1 = sizeof($data->brother_or_sisters) > 0 ? $data->brother_or_sisters[0] : null;
                           $brotherSister2 = sizeof($data->brother_or_sisters) > 1 ? $data->brother_or_sisters[1] : null;
                           $brotherSister3 = sizeof($data->brother_or_sisters) > 2 ? $data->brother_or_sisters[2] : null;
                           $brotherSister4 = sizeof($data->brother_or_sisters) > 3 ? $data->brother_or_sisters[3] : null;
                           $brotherSister5 = sizeof($data->brother_or_sisters) > 4 ? $data->brother_or_sisters[4] : null;
                     @endphp
                     <!-- /.card-header -->
                     <!-- form start -->
                     <div class="card-body">
                        <div class="form-group row">
                           ...
                           <div class="col-md-4">
                              ...
                              id="brotherOrSisterName1" placeholder="Enter brother's or sister's name" value="{{old('brotherOrSisterName1')? old('brotherOrSisterName1') : ($brotherSister1? $brotherSister1->name : '') }}" >
                              @if($errors->any())
                           ...
                           <div class="col-md-4">
                              ...
                              <div class="col-md-4">
                                 ...
                                 id="brotherOrSisterGrade1" placeholder="Enter grade brother's or sister's" value="{{old('brotherOrSisterGrade1') ? old('brotherOrSisterGrade1') : ($brotherSister1? $brotherSister1->grade : '')}}" >
                                 @if($errors->any())
                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-md-4">
                                 ...
                                 id="brotherOrSisterName2" placeholder="Enter brother's or sister's name" value="{{old('brotherOrSisterName2')? old('brotherOrSisterName2') : ($brotherSister2? $brotherSister2->name : '') }}">
                                 @if($errors->any())
                              ...
                              <div class="col-md-4">
                                 ...
                                 <div class="col-md-4">
                                    ...
                                    id="brotherOrSisterGrade2" placeholder="Enter grade brother's or sister's" value="{{old("brotherOrSisterGrade2")? old("brotherOrSisterGrade2") : ($brotherSister2? $brotherSister2->grade : '')}}">
                                    @if($errors->any())
                              ...
                              <div class="form-group row">
                                 <div class="col-md-4">
                                    ...
                                    id="brotherOrSisterName3" placeholder="Enter brother's or sister's name" value="{{old('brotherOrSisterName3')? old('brotherOrSisterName3') : ($brotherSister3? $brotherSister3->name : '') }}">
                                    @if($errors->any())
                                 ...
                                 <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                       ...
                                       id="brotherOrSisterGrade3" placeholder="Enter grade brother's or sister's" value="{{old('brotherOrSisterGrade3') ? old('brotherOrSisterGrade3') : ($brotherSister3? $brotherSister3->grade : '')}}">
                                       @if($errors->any())
                              ...
                              <div class="form-group row">
                                 <div class="col-md-4">
                                    ...
                                    id="brotherOrSisterName4" placeholder="Enter brother's or sister's name" value="{{old('brotherOrSisterName4')? old('brotherOrSisterName4') : ($brotherSister4? $brotherSister4->name : '') }}" >
                                    @if($errors->any())
                                 ...
                                 <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                       ...
                                       id="brotherOrSisterGrade4" placeholder="Enter grade brother's or sister's" value="{{old('brotherOrSisterGrade4') ? old('brotherOrSisterGrade4') : ($brotherSister4? $brotherSister4->grade : '')}}">
                                       @if($errors->any())
                              ...
                              <div class="form-group row">
                                 <div class="col-md-4">
                                    ...
                                    id="brotherOrSisterName5" placeholder="Enter brother's or sister's name" value="{{old('brotherOrSisterName5')? old('brotherOrSisterName5') : ($brotherSister5? $brotherSister5->name : '') }}">
                                    @if($errors->any())
                                 ...
                                 <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                       ...
                                       id="brotherOrSisterGrade5" placeholder="Enter grade brother's or sister's" value="{{old('brotherOrSisterGrade5') ? old('brotherOrSisterGrade5') : ($brotherSister5? $brotherSister5->grade : '')}}" >
                                       @if($errors->any())
