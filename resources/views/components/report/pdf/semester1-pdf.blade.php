    ...
    <!-- PAGE 1 -->
        ...
        <div>
            <table class="table">
                ...
                <tr>
                    <td style="text-align:right;border: 1px dotted black;padding-right:8px;border-left: solid 1px black;" colspan="2">Name:</td>
                ...
                <tr>
                    <td style="text-align:right;border: 1px dotted black;padding-right:8px;border-left: solid 1px black;" colspan="2">Class:</td>
                ...
                <tr>
                    <td style="text-align:right;border: 1px dotted black;padding-right:8px;border-left: solid 1px black;" colspan="2">Serial:</td>
                ...
                <tr>
                    <td style="text-align:right;border: 1px dotted black;padding-right:8px;border-left: solid 1px black;" colspan="2">Days Absent:</td>
                ...
                <tr>
                    <td style="text-align:right;border: 1px dotted black;padding-right:8px;border-left: solid 1px black;" colspan="2">Times Late:</td>
                ...
                <tr>
                    ...
                    <td style="border: 1px dotted black;border-right: solid 1px black;padding-left:10px;" colspan="6">The student has demonstrated some of the required knowledge and skills in limited ways. <br> Achievement falls much below the standard.</td>
                </tr>
                <tr>
