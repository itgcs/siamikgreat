...
<div class="container-fluid">
   ...
   <div class="row">
      <a type="button" href="{{ url('/' . session('role') . '/majorSubjects/create') }}" class="btn btn-success btn mt-5 mx-2">   <i class="fa-solid fa-user-plus"></i>
         </i>   
         Add Major subject
      </a>
   </div>
...
<script>
   ...
   setTimeout(() => {
      Toast.fire({
         icon: 'success',
         title: 'Successfully created new major subject in the database.',
   });
   }, 1500);
...
@if(session('after_delete_subject')) 
   ...
   <script>
      ...
      setTimeout(() => {
         Toast.fire({
            icon: 'success',
            title: 'Successfully deleted major subject in the database.',
      });
      }, 1500);
